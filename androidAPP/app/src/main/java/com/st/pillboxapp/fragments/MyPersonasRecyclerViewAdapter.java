...
import com.st.pillboxapp.fragments.PersonasFragment.OnListFragmentInteractionListener;
...
public class MyPersonasRecyclerViewAdapter extends RecyclerView.Adapter<MyPersonasRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPersonasRecyclerViewAdapter(Context ctx, int layout, List<Persona> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
        this.ctx = ctx;
    }
